...
public class CustomerTests : IAsyncLifetime
{
    ...
    public CustomerTests(CustomerApiFactory waf)
    {
        _httpClient = waf.HttpClient;
    ...
    public async Task Get_ShouldReturnCustomer_WhenCustomerExists()
    {
        ...
        var createdCustomerResponse = await _httpClient.PostAsJsonAsync("customers", request);
    ...
    public async Task GetAll_ShouldReturnAllCustomers_WhenCustomersExist()
    {
        ...
        var createCustomerHttpResponse = await _httpClient.PostAsJsonAsync("customers", request);
    ...
    public async Task Update_ShouldUpdateCustomerDetails_WhenDetailsAreValid()
    {
        ...
        var createCustomerHttpResponse = await _httpClient.PostAsJsonAsync("customers", createRequest);
        var createdCustomer = await createCustomerHttpResponse.Content.ReadFromJsonAsync<CustomerResponse>();
        ...
        // Act
        var response = await _httpClient.PutAsJsonAsync($"customers/{createdCustomer!.Id}", updateRequest);
